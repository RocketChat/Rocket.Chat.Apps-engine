...
import { IDiscussion, IRoom, RoomType } from '../rooms';
...
export interface IDiscussionBuilder {
     ...
     */
    setData(room: IDiscussion): IDiscussionBuilder;
     ...
     */
    setDisplayName(name: string): IDiscussionBuilder;
     ...
     */
    setSlugifiedName(name: string): IDiscussionBuilder;
     ...
     */
    setCreator(creator: IUser): IDiscussionBuilder;
     ...
     */
    addUsername(username: string): IDiscussionBuilder;
     ...
     */
    setUsernames(usernames: Array<string>): IDiscussionBuilder;
     ...
     * @param username the user's username to add to the room
     */
    addMemberToBeAddedByUsername(username: string): IDiscussionBuilder;
     ...
     * @param usernames the list of usernames
     */
    setMembersToBeAddedByUsernames(usernames: Array<string>): IDiscussionBuilder;
     ...
     */
    setDefault(isDefault: boolean): IDiscussionBuilder;
     ...
     */
    setReadOnly(isReadOnly: boolean): IDiscussionBuilder;
     ...
     */
    setDisplayingOfSystemMessages(displaySystemMessages: boolean): IDiscussionBuilder;
     ...
     */
    addCustomField(key: string, value: object): IDiscussionBuilder;
     ...
     */
    setCustomFields(fields: { [key: string]: object }): IDiscussionBuilder;

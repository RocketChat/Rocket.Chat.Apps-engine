import { IRoomSubscriptionIterator } from '../subscriptions';
...
export interface IRoomSubscriptionRead {
     ...
     */
    getByRoomId(roomId: string): Promise<IRoomSubscriptionIterator>;
     ...
     */
    getByUserId(userId: string): Promise<IRoomSubscriptionIterator>;
}
